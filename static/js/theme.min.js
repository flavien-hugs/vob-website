...
!function () {
    ...
    function (e) {
        ...
        $(this).is('ul') && $(this).addClass('in') : $(this).addClass('active')
    })
}(),

function () {
    var e;
    $('.course-list').length && $('.course-list').slimScroll({height: '100%'}),
    ...
    $('.stopevent').length && $(document).on(
        'click.bs.dropdown.data-api', '.stopevent', function (e) {
        e.stopPropagation()
    })
}();
