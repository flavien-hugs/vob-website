# Generated by Django 3.2 on 2022-01-02 21:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, choices=[('Motivation', 'Motivation'), ('Entrepreneuriat', 'Entrepreneuriat')], default='Entrepreneuriat', help_text="Définir le type de catégorie de l'article.", max_length=20, null=True, unique=True, verbose_name="type de catégorie d'article")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='uuid')),
                ('slug', models.SlugField(blank=True, editable=False, help_text='Automatiquement formé à partir du nom.', null=True, unique=True, verbose_name='slug')),
                ('title', models.CharField(help_text="Définir le titre de l'article.", max_length=255, unique=True, verbose_name="titre de l'article")),
                ...
                ('reading', models.CharField(choices=[('Gratuit', 'Gratuit'), ('Payant', 'Payant')], default='Payant', help_text="définir l'option de lecture de cet article.", max_length=10, verbose_name='Option de lecture')),
